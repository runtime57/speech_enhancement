...
class EncoderGRNN_XConv(nn.Module):
...
class ErbDecoder_XConv(nn.Module):
    def __init__(self, params):
        super().__init__()
        p = params
        layer_width = p.conv_ch
...
class DfNetXConvGRNN(nn.Module):
    def __init__(
        self,
        run_df: bool = True,
        ...
        self.enc = EncoderGRNN_XConv(self)
        self.erb_dec = ErbDecoder_XConv(self)
